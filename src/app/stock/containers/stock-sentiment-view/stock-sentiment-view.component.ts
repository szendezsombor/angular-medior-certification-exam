...
export class StockSentimentViewComponent implements OnInit {
  ...
  constructor(private activatedRoute: ActivatedRoute, private stockFacade: StockFacade, private stockSentimentFacade: StockSentimentFacade) {
  }

  ngOnInit(): void {
    this.activatedRoute.paramMap.pipe(tap((paramMap: ParamMap) => {
